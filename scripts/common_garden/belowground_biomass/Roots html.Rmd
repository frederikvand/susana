...
bakken_shoots = subset(bakken_shoots, select = c(column, row, ID, substrate.x, plant, length, nr, t, time, date, layer, shoot_biomass) )
bakken_shoots$ID = bakken_shoots$ID
bakken_shoots$substrate = bakken_shoots$substrate.x
bakken_shoots = subset(bakken_shoots, select = -c(ID, substrate.x) )
